...
function OfferSliderProductOfferTimer(): ReactElement {
  return (
    <section className="w-full">
      <div className="w-full p-5 bg-red-200/60 text-red-600 rounded-t-2xl text-sm flex flex-row-reverse justify-between items-center border-t-4 border-red-500">
        <Image
